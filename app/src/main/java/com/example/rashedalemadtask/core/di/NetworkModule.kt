...
object NetworkModule {
    ...
    fun provideRetrofit(
        ...
        return Retrofit.Builder().baseUrl(Globalvars.BaseUrl).client(okHttpClient)
    ...
    @Singleton
    @Provides
    fun provideCurrencyService(retrofit: Retrofit): RestWebService =
        retrofit.create(RestWebService::class.java)
